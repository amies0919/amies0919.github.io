...
//  
	...
	window.onload = function(){
		...
		if(curr == 'black'){
			this.style.background = 'url(/static/images/playB.png) -1px 0 no-repeat';
			this.hasEle = curr == 'white'?'w':'b';
			curr = 'white';
		}else{
			this.style.background = 'url(/static/images/playA.png) -1px 0 no-repeat';
			this.hasEle = curr == 'white'?'w':'b';
			curr = 'black';
		}
